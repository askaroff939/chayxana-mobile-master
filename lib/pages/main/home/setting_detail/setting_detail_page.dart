...
class SettingDetailPage extends StatelessWidget {
  ...
  SettingDetailController settingDetailController =
      Get.find<SettingDetailController>();
          ...
          body: SizedBox(
            ...
            child: ListView(
              ...
              children: [
                ...
                customDivider(),
                Visibility(
                  visible: settingDetailController.isCome,
                  child: Column(
                    children: [
                      Container(
                        height: 376,
                        ...
                        child: ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            return ChooseRoom(
                                ...
                                maxPeople: controller.rooms[index][1],
                                minPeople: controller.rooms[index][2],
                                price: controller.rooms[index][3]);
                          },
                        ),
                      ),
                      Visibility(
                        visible: controller.isCome2,
                        child: orderCountPeopleAndMonth(
                          title: controller
                                  .getItem(
                                      'month',
                                      controller
                      ...
                      Visibility(
                        ...
                        child: Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              DatePicker(
                                controller.chooseMonth == DateTime.now().month
                                    ? DateTime.now()
                                    : DateTime(
                                        DateTime.now().year,
                                        controller.chooseMonth,
                                      ),
                                width: Get.width * .175,
                                ...
                                daysCount: controller.chooseMonth !=
                                        DateTime.now().month
                                    ? controller
                                        .monthDays(controller.chooseMonth)
                                    : controller
                                            .monthDays(controller.chooseMonth) -
                                        DateTime.now().day +
                                        1,
                                ...
                                onDateChange: (date) {
                                  ...
                                  controller
                                      .addWeekday(date.weekday.toString());
                                },
                                inactiveDates: controller.isNotEmpty,
